...
param['IOS'] = {"networkType": "Swlw", "model": "k3LE", "packageName": "VQFA", "userAgent": "0aew", "custID": "pnPb",
                "totalSystem": "bxIT", "resolution": "9_vV", "IDFA": "bA0Q", "version": "XKTz", "sdkVersion": "Vkrm",
                "appList": "nt7F", "brightness": "qm7W", "startupTime": "oA3w", "battery": "89Fw", "carrier": "WANY",
                "isProxy": "m6C7", "appCache": "9PRr", "coordinates": "Kavb", "platform": "0pT8", "fork": "jQx6",
                "totalMemory": "oUvy", "cellularIP": "PneH", "availableSystem": "H6Rg", "IDFV": "sxWp",
                "wifiList": "wXg4", "appVersion": "wfQn", "isVPN": "G0rn", "account": "mvIR", "rooted": "UqMW",
                "contactsHash": "kClR", "language": "pO8w"}
...
param['AND'] = {"uevent": "0Qzb", "networkType": "Swlw", "packageName": "VQFA", "availableMemory": "qiHP",
                ...
                "time": "M2B0", "sensorList": "BtS2", "phoneNumber": "nrYU", "existQemu": "JC9t", "isProxy": "m6C7",
                "parameters": "9Sgh", "appCache": "9PRr", "platform": "0pT8", "availableSD": "Uaj4", "host": "R0Cu",
                "networkOperator": "csj7", "cellularIP": "PneH", "ppp": "xCiW", "voiceMailNumber": "d8FW",
                "board": "hZFp", "availableSystem": "H6Rg", "wifiList": "wXg4", "appVersion": "wfQn",
                "manufacturer": "EAAo", "runningList": "gCnN", "isVPN": "G0rn", "contactsHash": "kClR",
                "cpuABI": "U3oU", "model": "k3LE", "hardware": "Jnh9", "phoneType": "LrgZ", "userAgent": "0aew",
                "displayRom": "2vam", "wifiMacAddress": "_Y6j", "switch": "eLSf", "timeZone": "q5aJ",
                "resolution": "9_vV", "musicHash": "FNei", "version": "XKTz", "sdkVersion": "Vkrm",
                "brightness": "qm7W", "photosHash": "GLBj", "id": "pWFF", "startupTime": "oA3w", "fingerprint": "RIY7",
                "currentWifi": "bOhy", "battery": "89Fw", "UDID": "NfP-", "simCountryIso": "Hx1a",
                "coordinates": "Kavb", "tags": "l4wv", "cpufreq": "DR1H", "simSerialNumber": "WCxt",
                "totalMemory": "oUvy", "IMSI": "7UTv", "IOPorts": "4-es", "bootloader": "O0oS", "totalSD": "LtgM",
                "stat": "QEYN", "misc": "nDJC", "allList": "CneL", "product": "qHkh", "adb": "fhag",
                "bluetooth": "qCjR", "networkCountryIso": "lRtB", "syncookies": "4MYi", "nearbyBaseStation": "EyOF",
                "IMEI": "9POg", "device": "JjpN", "account": "mvIR", "radio": "qjoF", "rooted": "UqMW", "brand": "BKn7",
                "user": "BPiZ", "serial": "AUSx"}
...
def generate_post_4(request):
    return requests.post(url="http://10.100.1.53:9080/public/generate/post", json=request.param)
...
def generate_post_3(request):
    return requests.post(url="http://10.100.1.53:9080/api/device-fingerprint", json=request.param)
